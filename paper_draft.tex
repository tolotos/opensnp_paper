...
Crowdsourcing, giving a task into the hands of a potentially large number of Ð mainly intrinsically motivated Ð people, has become a widely used practice in the internet age and is getting adopted in the realm of science as well, with Galaxy Zoo and FoldIt (CITATIONS NEEDED) being two of the most-well known examples. 
...
Similarly crowdsourcing can not only be applied to analyzing data, but also to collecting data. Ornithology has been doing this for years (CITATION NEEDED). With the advent of DTC genetic testing and the internet a similar approach can now be brought to human genetics.
