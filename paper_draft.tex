...
\fabian{That is a good summary, but as Bastian pointed out the reuse is not only
...
\fabian{If that is true, rephrase sentence above. Made two sentences out of one.}
...
\fabian{
I changed the structure of the paragraph to make it a little bit more
concise.I think its best to connect the phenotypes to the above paragraph, explain
...
\fabian{I think we should clarify the difference between variaton and phenotype!}
