...
%
Here, we present openSNP, a crowdsourced resource that enables customers of DTC testing companies to share their genotypings with researchers and receive new annotation for their genetic variants. We have shown that customers of DTC companies are willing to share their data at no cost to researchers around the world and are willing to annotate their data with phenotypes.
...
widely available genetic information. DTC genetic testing companies themselves also try to create communities that help in educating their customers about the risks of releasing genetic data \cite{Lee2009}. Neither GINA nor the GenDG offer a complete protection of genetic discrimination, as certain things, such as life insurances, are not covered by those laws.  
...
By offering a platform where customers of DTC genetic testing can publish their data openSNP for the general public tries to enable and facilitate the re-use of this already generated data. Allowing interested parties to use the data for studies on their own allows people to perform studies without the need to generate genetic data on their own. Additionally the data can be used to enrich other data sets in order to overcome limited sample sizes, which is especially of interest for rare diseases. 
